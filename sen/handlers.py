    ...
    async def _handle_conversation_inner(message: Message, bot: "Bot", temp_forget: bool):
        ...
        try:
            ...
            instructions = (
                ...
                "Do NOT use <p>, <div>, <section>, or <article> in Rich HTML.\n"
                "Structure: Use <h1>-<h6> for section headings based on importance (h1 for main title, h2 for subsections, h3 for sub-subsections). When a response has multiple sections or data types (tables, equations, lists), use nested collapsible sections. Put a parent <details><summary>Section Title</summary>...</details> around the whole thing, and put each distinct element (table, equation, list) in its own child <details><summary>...</summary>...</details> inside it.\n"
