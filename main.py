...
# Secure configuration check to pull the key dynamically from Railway's environment
gemini_api_key = os.getenv("GEMINI_API_KEY")
if not gemini_api_key:
    raise ValueError(
        "CRITICAL CONFIGURATION ERROR: The 'GEMINI_API_KEY' environment variable is missing or empty. "
        "Please ensure GEMINI_API_KEY is configured in your Railway dashboard."
    )
        ...
        if is_tagged or is_reply_to_bot or is_private:
            ...
            if clean_prompt or replied_context:
                ...
                try:
                    ...
                    # Corrected the model identifier to 'gemini-2.5-flash'
